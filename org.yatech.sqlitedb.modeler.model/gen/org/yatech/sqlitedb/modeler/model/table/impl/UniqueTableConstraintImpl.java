 ...
 * <ul>
 *   <li>{@link org.yatech.sqlitedb.modeler.model.table.impl.UniqueTableConstraintImpl#getColumns <em>Columns</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UniqueTableConstraintImpl extends TableConstraintImpl implements UniqueTableConstraint {
	...
	public EList<IndexedColumn> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentEList<IndexedColumn>(IndexedColumn.class, this, TablePackage.UNIQUE_TABLE_CONSTRAINT__COLUMNS);
		}
		return columns;
	}
